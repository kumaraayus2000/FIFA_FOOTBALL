...
const ChoosePlayers = () => {
  ...
  const handleStartGame = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:8080/api/gamesim/start", requestBody, {
        ...
        <DialogContent>
          {apiResponse ? (
            <Box>
              ...
              <Typography variant="body1">
                <strong>Team 1 Players Below 60:</strong> {apiResponse.idsBelow60Team1.join(", ") || "None"}
              </Typography>
              <Typography variant="body1">
                <strong>Team 2 Players Below 60:</strong> {apiResponse.idsBelow60Team2.join(", ") || "None"}
              </Typography>
            </Box>
          ) : (
